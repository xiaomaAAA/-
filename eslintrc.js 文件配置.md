...
module.exports = {
  ...
  "rules": {
    ...
    "object-curly-spacing": [2, "always"], // 结构复制首位有空格
...
![63020a70-da14-11e9-9cb4-cbc8a72cab53](https://gitee.com/supcoolMa/store_pictures/raw/master/img/b5d02930-da14-11e9-9cb4-cbc8a72cab53.png)



#### 2.打开 Setting.json 文件

点击设置面板右上角的，三个点 图标，选择setting.json

![b5d02930-da14-11e9-9cb4-cbc8a72cab53](https://gitee.com/supcoolMa/store_pictures/raw/master/img/63020a70-da14-11e9-9cb4-cbc8a72cab53.png)





#### 3.复制配置json数据到 用户设置区域
...
![ebe475d0-da14-11e9-9cb4-cbc8a72cab53 (https://gitee.com/supcoolMa/store_pictures/raw/master/img/ebe475d0-da14-11e9-9cb4-cbc8a72cab53 (1).png)](C:\Users\Administrator\Desktop\ebe475d0-da14-11e9-9cb4-cbc8a72cab53 (1).png)



#### 4.推荐的vscode插件，eslint必装

- ESLint。 开启 eslint 必须装的插件
- Chinese (Simplified) Language Pack for Visual Studio Code。vscode 汉化包
- IntelliJ IDEA Keybindings。 将修改和idea相同的快捷键，方便在切换webstorm时，快捷键不统一的问题。
- vscode-icons。给文件加图标。